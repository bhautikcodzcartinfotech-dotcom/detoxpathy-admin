...
// export const API_BASE = "http://192.168.1.39:3002/api/v1";
...
export const getVideoReports = async (params = {}) => {
  const res = await axios.get(`${API_BASE}/admin/video/reports`, {
    headers: getAuthHeaders(),
    params
  });
  return res.data.data;
...
export const deletePatientHistoryApi = async (id) => {
  const res = await axios.delete(`${API_BASE}/admin/patientHistory/delete/${id}`, {
    headers: getAuthHeaders(),
  });
  return res.data;
};
...
export const bulkApproveFeedbacks = async (ids, field, isApproved = true) => {
  const res = await axios.put(`${API_BASE}/admin/feedback/bulk-approve`, { ids, field, isApproved }, {
    headers: getAuthHeaders(),
  });
  return res.data;
};
...
/* -------------------- BRANCH TIME REQUEST APIs -------------------- */
export const listBranchTimeRequests = async (branchId = "") => {
  const url = branchId
    ? `${API_BASE}/admin/branchTime/requests/${branchId}`
    : `${API_BASE}/admin/branchTime/requests`;
...
export const approveBranchTimeRequest = async (requestId) => {
  const res = await axios.post(`${API_BASE}/admin/branchTime/requests/${requestId}/approve`, {}, {
    headers: getAuthHeaders(),
  });
  return res.data.data;
};

export const rejectBranchTimeRequest = async (requestId, adminComment = "") => {
  const res = await axios.post(`${API_BASE}/admin/branchTime/requests/${requestId}/reject`, { adminComment }, {
    headers: getAuthHeaders(),
  });
  return res.data.data;
};
