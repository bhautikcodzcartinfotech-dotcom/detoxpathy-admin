...
import { FiEdit, FiTrash2, FiClock, FiInfo, FiPlusCircle, FiEye, FiLogIn, FiCalendar, FiChevronUp, FiChevronDown, FiCheck, FiRefreshCw } from "react-icons/fi";
...
export const ActionButton = ({ type = "edit", onClick, disabled = false, title = "" }) => {
  ...
  const styles = {
    ...
    restore: "bg-green-50 text-green-600 hover:bg-green-600 hover:text-white shadow-green-900/5 hover:shadow-green-900/20"
